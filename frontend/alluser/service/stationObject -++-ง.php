...
if(isset($_POST['act']) && $_POST['act'] == "getTickets"){
    ...
    $sql = "select *,o.origin_name origin,t.terminal_name terminal,c.company_name ,r.carservice_vehicle car from tb_station s 
    ...
    where s.station_origin_name = '$p_origin' and s.station_terminal_name = '$p_terminal' order by s.station_id";
