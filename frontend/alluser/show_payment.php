...
<div class="contact">
    ...
    <div class="container">
        <div class="" style="text-align: center;">
            <h3 style="color:black;font-weight:bold;">รายการจองตั๋ว</h3>
        </div>
        <div class="">
            ...
            <table>
                ...
                <tbody>
                    ...
                    if (isset($_SESSION['user_idcard'])) {
                        ...
                        $sql = "SELECT * FROM tb_tickets WHERE status = 0 AND user_idcard = '$user_idcard' ORDER BY tickets_id DESC";
                        $result = $cls_conn->select_base($sql);
                        while ($row = $result->fetch_assoc()) {
                            $tickets_id = $row['tickets_id'];
                            $price_tickets = $row['station_price_tickets'];
                            $tickets_no = $row['tickets_no'];
                            $status = $row['status'];
                            $ticket_type = $row['tickets_type'];
                            $times_tickets = $row['tickets_date_time'];
                            ?>
                        ...
                        <tbody class="tbl-accordion-header">
                            <tr>
                                <td>
                                    <a href="pay_tickets.php?tickets_id=<?= $tickets_id ?>"
