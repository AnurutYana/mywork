                ...
                <table id="datatable-buttons" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>รหัสฝากพัสดุ</th>
                            <th>หมายเลขพัสดุ</th>
                            <th>รหัสรายการตารางเวลาเดินรถ</th>
                            <th>ชื่อผู้ส่ง</th>
                            <th>ชื่อผู้รับ</th>
                            <th>วันเวลาจอง</th>
                            <th>จำนวนพัสดุ</th>
                    ...
                    <tbody>
                        <?php
                        $sql = " SELECT *,u.user_fname,u.user_surname from tb_package p join tb_user u on u.user_idcard = p.user_idcard order by p.package_id desc";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?= $row['package_fname']." ".$row['package_lname']; ?>
                                </td>
                                <td>
