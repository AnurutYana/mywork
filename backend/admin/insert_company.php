                ...
                <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="company_add" name="company_add" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="tel" id="company_tel" name="company_tel" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $check = "select * from  tb_company where company_name='$company_name'";
                        $result = $cls_conn->select_base($check);
                        if($result->num_rows>=1){
                            echo $cls_conn->show_message('มีข้อมูลบริษัทแล้ว กรุณากรอกข้อมูลใหม่');

                        }else{
                            $sql = " insert into tb_company(company_name, company_add, company_tel)";
                            $sql .= " values ('$company_name','$company_add','$company_tel')";
