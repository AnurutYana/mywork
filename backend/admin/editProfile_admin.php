                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <input type="text" name="admin_lname" required="required" placeholder="นามสกุล" value=<?=$admin_lname;?> class="form-control col-md-7 col-xs-12">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="file" id="admin_image" name="admin_image" <?= $admin_image;?> class="form-control col-md-7 col-xs-12"> 
                                <div class="">
